...
describe('Certificate for electricity consumption transaction (national)', async function () {
     ...
     */
    it('Request Intermediate (national)', async function () {
        this.timeout(35000);
     ...
     */
    it('Request Certificate (national)', async function () {
        this.timeout(55000);
     ...
     */
    it('Certificate Consensus (national)', async function () {
        this.timeout(35000);
     ...
     */
    it('Signature Validation (Offline Check) (national)', async function () {
        this.timeout(35000);
     ...
     */
    it('OnChain Consensus NFT Token (GHG Certificate) (national)', async function () {
        this.timeout(35000);
     ...
     */
    it('OnChain Consensus ERC20 Token GHG Savings (national)', async function () {
        this.timeout(35000);
    ...
    it('OnChain Consensus ERC20 Token GHG Emissions (national)', async function () {
        this.timeout(35000);
